"""PayU adapter — payment behaviour.
...
class PayUAdapter(EnrichmentAdapter):
    source_name = "payu"
    ...
    def _mock_matched_payload(rec: CanonicalRecord, rng: random.Random) -> dict[str, Any]:
        ...
        return {
            ...
            "failed_payments": rng.randint(0, 5),
            "avg_transaction_value": round(rng.uniform(500, 50_000), 2) if successful else 0.0,
            "last_payment_status": rng.choice(["success", "failed", "pending"]),
        }
